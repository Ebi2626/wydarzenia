...
class WP_Event_Manager_Post_Types {
	...
	public function __construct() {
		...
		// Akcja dodana w ramach customizacji	
		add_action( 'event_manager_registration_details_online', array( $this, 'registration_details_online' ) );		
	...
	*/
	...
	// Customowa metoda rejestracji
	public function registration_details_online( $register ) {
		get_event_manager_template( 'event-registration-online.php', array( 'register' => $register ) );
	}
